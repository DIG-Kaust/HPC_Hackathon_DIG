...
from pyproximal import L1, L21, VStack
from pyproximal.optimization.primaldual import PrimalDual

from scripts.Simplex_gpu import *

def Segment_gpu(y, cl, sigma, alpha, clsigmas=None, z=None, niter=10, x0=None,
    ...
    simp = Simplex_gpu(dimsprod * ncl, radius=1, dims=(ncl, dimsprod), axis=0,
                   **kwargs_simplex)
